...
import { pgTable, serial, text, jsonb, timestamp, integer, boolean, vector, index, uniqueIndex, varchar, real } from "drizzle-orm/pg-core";
 ...
 */
export const websites = pgTable("rag_websites", {
