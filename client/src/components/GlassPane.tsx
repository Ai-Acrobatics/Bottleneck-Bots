...
export const GlassPane: React.FC<GlassPaneProps> = ({ children, className = '', title, headerAction }) => {
  return (
    <div className={`glass-panel rounded-2xl overflow-hidden flex flex-col transition-all duration-300 hover:shadow-2xl hover:shadow-emerald-500/10 ${className}`}>
      {(title || headerAction) && (
