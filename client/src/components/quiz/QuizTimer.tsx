...
export function QuizTimer({ timeLimit, onExpire }: QuizTimerProps) {
  ...
  return (
    <div className={`sticky top-16 z-30 ${isWarning ? 'animate-pulse' : ''}`}>
      <Alert className={isWarning ? 'border-red-500 bg-red-50 dark:bg-red-950' : ''}>
        <div className="flex items-center gap-2">
          ...
          <AlertDescription className={`font-mono text-lg font-semibold ${isWarning ? 'text-red-600 dark:text-red-400' : ''}`}>
