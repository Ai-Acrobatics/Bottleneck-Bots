        ...
        <div className="container mx-auto px-4 sm:px-6 h-16 sm:h-20 flex items-center justify-between">
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div>
              ...
              <div className="hidden sm:block text-[11px] text-slate-700 font-semibold -mt-1">Buy Back Your Freedom</div>
            </div>
          </div>
      ...
      <header id="main-content" className="relative pt-12 sm:pt-20 pb-12 sm:pb-16 overflow-hidden" role="banner">
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          ...
          <p className="text-sm sm:text-lg text-slate-600 mb-8 sm:mb-12 max-w-3xl mx-auto text-center animate-in fade-in slide-in-from-bottom-8 duration-700 delay-300">
            <span className="font-bold text-slate-800">Real talk:</span> This isn't another chatbot that "sounds smart but does nothing." This is the AI workforce that handles your fulfillment while you're at dinner with your family. <span className="underline decoration-purple-400 decoration-2">No more 2am emergency Slack messages.</span>
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 mb-4 sm:mb-6 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-400 px-4">
            ...
            <Button
              ...
              className="w-full sm:w-auto rounded-full px-6 sm:px-10 h-12 sm:h-16 text-base sm:text-xl font-bold border-2 border-purple-300 hover:bg-purple-50 text-slate-800 shadow-lg animate-bounce-subtle active:scale-95 transition-transform"
            >
          ...
          <div className="text-center text-xs sm:text-sm text-slate-600 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-500 px-4">
            ...
            <p className="font-medium">
              <span className="font-bold text-purple-600">487 agency owners</span> have reclaimed their time and sanity
            </p>
          </div>
